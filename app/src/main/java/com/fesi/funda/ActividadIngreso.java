...
public class ActividadIngreso extends AppCompatActivity implements GoogleApiClient.OnConnectionFailedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        loginButton.registerCallback(callbackManager, new FacebookCallback<LoginResult>() {
            ...
            public void onCancel() {
                hideProgressDialog();
                Toast.makeText(ActividadIngreso.this, "Inicio sesión cancelado", Toast.LENGTH_SHORT).show();
            }
...
//                    Toast.makeText(ActivityRegistro.this, AccessToken.getCurrentAccessToken().getExpires().toString() + user.getEmail(), Toast.LENGTH_SHORT).show();
        ...
        mAuthListener = new FirebaseAuth.AuthStateListener() {
            ...
            public void onAuthStateChanged(@NonNull FirebaseAuth firebaseAuth) {
                ...
                if (firebaseUser != null) {
                    Toast.makeText(ActividadIngreso.this,
                            "Bienvenido: ",
                    ...
                    hideProgressDialog();
                    Toast.makeText(ActividadIngreso.this, "Sesion Cerrada", Toast.LENGTH_LONG);
            ...
            firebaseAuth.signInWithCredential(authCredential).addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                ...
                public void onComplete(@NonNull Task<AuthResult> task) {
                    if (task.isSuccessful()) {
                        ...
                        hideProgressDialog();
                        Toast.makeText(ActividadIngreso.this, "Algo sucedió Google!! ", Toast.LENGTH_LONG);
                    }
                ...
                .addOnCompleteListener(this, new OnCompleteListener<AuthResult>() {
                    ...
                    public void onComplete(@NonNull Task<AuthResult> task) {
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(ActividadIngreso.this, "Falló la Autenticación.",
                                    Toast.LENGTH_SHORT).show();
                            hideProgressDialog();
                        }
                    }
    ...
    private void setButtonListeners() {
        ...
        btn_olvide.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
